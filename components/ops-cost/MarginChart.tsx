  ...
  return (
    <div className="bg-card rounded-xl border border-border/60 p-6">
      <h3 className="font-display text-lg font-semibold text-foreground mb-1">
        {ts.ops_marginCurveTitle ?? "Margin % vs. Volume"}
      </h3>
      <p className="text-sm text-muted-foreground mb-4">
        {ts.ops_marginCurveDesc ??
          "Identifies the sweet spot where margins peak before capacity constraints compress them"}
      </p>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <RechartsTooltip
              ...
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              formatter={(value: any) => [`${Number(value ?? 0).toFixed(1)}%`, ts.ops_margin ?? "Margin"]}
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            <ReferenceLine
              ...
              strokeWidth={1}
              label={{
                value: ts.ops_breakEvenLabel ?? "Break-Even",
                position: "right",
                fill: "#ef4444",
                fontSize: 11,
              }}
